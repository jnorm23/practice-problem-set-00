...
const isPerfectSquare = require("../problems/is-perfect-square");
...
describe("isPerfectSquare", function() {
  ...
  it('isPerfectSquare(2) returns true', function () {
    expect(isPerfectSquare(2)).to.be.false;
  });
  it('isPerfectSquare(40) returns true', function () {
    expect(isPerfectSquare(40)).to.be.false;
  });
  it('isPerfectSquare(32) returns true', function () {
    expect(isPerfectSquare(32)).to.be.false;
  });
  it('isPerfectSquare(50) returns true', function () {
